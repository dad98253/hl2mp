...
{
	bool bRet;
	bRet = SDKHookEx(client, SDKHook_OnTakeDamage, OnTakeDamage);
#if DEBUG	
	if(bRet)
		PrintToServer("client %i damage Hooked",client);
		
	else
		PrintToServer("client %i damage Hook failed",client);
#endif	
	if(fDefaultDamageMult != 1.0) 
...
///////////////////////////////////////////////////////////--CONFIGURATION--///////////////////////////////////////////////////////////
	...
	PrintToServer("Hook called: victim,attacker,inflictor,damage,damagetype,weapon = %i,%i,%i,%i,%i,%i",victim, attacker, inflictor, damage, damagetype, weapon);
	#endif
